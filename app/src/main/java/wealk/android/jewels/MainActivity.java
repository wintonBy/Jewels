...
public class MainActivity extends BaseGameActivity implements IOnAreaTouchListener {
	...
	//选项
	private Texture mMenuModelTexture,mMenuRankingTexture,mMenuQuitTexture,mMenuShutUpTexture;
	protected TextureRegion mMenuNewGameTextureRegion,mMenuRankingTextureRegion,mMenuQuitTextureRegion,mMenuShutUpRegion;	
	//字体
	...
	/*by winton*/
	private Sprite mShutUp;
	
	private Text mNewGameText,mRankingText,mQuitText,mShutUpText;
	//模式菜单
	...
	public void onLoadResources() {	
		...
		this.mDynamicBgroundTextureRegion = TextureRegionFactory.createFromAsset(this.mDynamicBgroundTexture, this, "gfx/winton.png", 0, 0);
		...
		//关闭音效
		this.mMenuShutUpTexture = new Texture(256, 256, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		this.mMenuShutUpRegion = TextureRegionFactory.createFromAsset(this.mMenuQuitTexture, this, "gfx/menubutton1.png", 0, 0);
		this.mEngine.getTextureManager().loadTexture(this.mMenuShutUpTexture);
		
		//字体
		this.mFontTexture = new Texture(256, 256, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		this.mFont = FontFactory.createFromAsset(this.mFontTexture, this, "fonts/winton.ttf", 24, true, Color.WHITE);
		this.mEngine.getTextureManager().loadTexture(this.mFontTexture);
		this.mEngine.getFontManager().loadFont(this.mFont); 
		this.mGreenFontTexture = new Texture(512, 512, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		this.mGreenFont = FontFactory.createFromAsset(this.mGreenFontTexture, this, "fonts/winton.ttf", 24, true, Color.WHITE);
	...
	public boolean onAreaTouched(TouchEvent pSceneTouchEvent,ITouchArea pTouchArea, float pTouchAreaLocalX,float pTouchAreaLocalY) {
		...
		}else if(pTouchArea.equals(mShutUp)){
			System.out.println("here");
			Toast.makeText(getApplicationContext(), "你是笨蛋", Toast.LENGTH_SHORT).show();
		}
...
//				this.mModelScene.back();
	...
	private void initAreaTouch(){
		...
		this.mMainScene.registerTouchArea(this.mShutUp);
	...
	private void initMenu(){
		...
		this.mNewGameText = new Text(centerX +80, 135, this.mFont, "新游戏");//文字
		...
		this.mRankingText = new Text(centerX +80, 205, this.mFont, "排行榜");//文字
		...
		this.mQuitText = new Text(centerX +85, 275, this.mFont, "退出");//文字
		this.mMainScene.getLayer(LAYER_MENU).addEntity(mQuitText);
		
		//关闭音效
		this.mShutUp = new Sprite(centerX, 340, this.mMenuShutUpRegion);
		this.mMainScene.getLayer(LAYER_BGROUND).addEntity(this.mShutUp);
		this.mShutUpText = new Text(centerX+75, 345, this.mFont, "关闭音效");
		this.mMainScene.getLayer(LAYER_MENU).addEntity(mShutUpText);
	}
	...
	private void initModel(){
		...
		this.mNormalModeText = new Text(centerX +65, 135, this.mFont, "普通模式");//文字
		...
		this.mTimedModeText = new Text(centerX +65, 205, this.mFont, "时间模式");//文字
		...
		this.mInfiniteModeText = new Text(centerX +65, 275, this.mFont, "无穷模式");//文字
		...
		final Text backText = new Text(centerX +100, 345, this.mFont, "返回");//文字
	...
	private void initNormalRank(){		
		...
		final Text selectModelText = new Text(centerX+65, 25, this.mFont, "时间模式");//文字
		...
		final Text backText = new Text(centerX +110, 75, this.mFont, "返回");//文字
		backText.setScale(0.8f, 0.9f);
	...
	private void initTimedRank(){
		...
		final Text selectModelText = new Text(centerX+65, 25, this.mFont, "普通模式");//文字
		selectModelText.setScale(0.7f, 0.8f);
